...
public class InstantSerializer implements JsonSerializer<Instant>, JsonDeserializer<Instant> {
    ...
    public JsonElement serialize(Instant src, Type typeOfSrc, JsonSerializationContext context) {
        return new JsonPrimitive(Converters.instantToTimestamp(src));
    }

    @Override
    public Instant deserialize(JsonElement src, Type typeOfSrc, JsonDeserializationContext context) {
        return Converters.timestampToInstant(src.getAsLong());
    }
}
